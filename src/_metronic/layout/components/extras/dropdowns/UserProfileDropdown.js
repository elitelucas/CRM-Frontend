      ...
      >
        ...
        >
          ...
          <span className="symbol symbol-35 symbol-light-success">
            {/* <Avatar alt={user.firstname ? user.firstname[0] : "F"} variant="rounded" src={user.pic} /> */}
            <Avatar alt={user.firstname ? user.firstname[0] : "F"} variant="rounded" src={process.env.REACT_APP_API_URL+"images/avatars/avatar.png"} />
          </span>
        </div>
      </Dropdown.Toggle>
