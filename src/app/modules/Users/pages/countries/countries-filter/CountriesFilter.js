...
export function CountriesFilter({ listLoading }) {
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(countriesUIProps.queryParams, values);
    if (!isEqual(newQueryParams, countriesUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      countriesUIProps.setQueryParams(newQueryParams);
    }
  };
